...
class AuthServiceImplTest {
    ...
    @Mock
    private RiderSeriveImpl riderService;
   ...
   void setUp() {
    ...
    void testLogin_whenSuccess() {
       // arrange
        ...
        when(jwtService.generateAccessToken(any(User.class))).thenReturn("accessTokenSuccess");
        when(jwtService.generateRefreshToken(any(User.class))).thenReturn("refreshTokenSuccess");
        ...
        assertThat(tokens[0]).isEqualTo("accessTokenSuccess");
        assertThat(tokens[1]).isEqualTo("refreshTokenSuccess");
